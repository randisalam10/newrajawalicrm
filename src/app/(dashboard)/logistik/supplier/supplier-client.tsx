...
export function SupplierClient({ initialData, canManage = true }: { initialData: any[], canManage?: boolean }) {
                ...
                <Table>
                    ...
                    <TableBody>
                        {initialData.length === 0 && (
                            <TableRow>
                                <TableCell colSpan={canManage ? 4 : 3} className="text-center text-muted-foreground h-24">
